...
cupom:
- Só preencher se houver código digitável após "cupom"/"código"/"use o cupom"/"Cupom:".
- Código: 4-20 chars [A-Z0-9_-], normalize para MAIÚSCULO.
- Se a linha tiver "Cupom: CODE1 ou CODE2", salve cupom=CODE1 (o primeiro).
- Se for "R$ X OFF", "% OFF", "cupom no anúncio/já aplicado/ative abaixo do produto", então cupom=null.
...
oferta:
- Junte SOMENTE linhas úteis de preço/pagamento e linhas sobre cupom.
